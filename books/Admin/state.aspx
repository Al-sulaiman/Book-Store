<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPage.master"CodeFile="state.aspx.cs" Inherits="Admin_state" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><table class="style1">
            ...
            <tr>
                <td class="style4">
                    State Name</td>
                <td>
                    <asp:TextBox ID="txt_snm" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style4">
