<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPage.master" CodeFile="Librarian reg.aspx.cs" Inherits="Admin_student_reg" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <tr>
                <td class="style2" colspan="2" 
                    ...
                    style="font-weight: 700; text-align: center; font-size: xx-large; color: #77B315;">
                    Librarian Registration</td>
            </tr>
            <tr>
                <td class="style5">
                    &nbsp;</td>
